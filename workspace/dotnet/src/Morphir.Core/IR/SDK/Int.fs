...
let moduleSpec: Module.Specification<unit> =
  { Types =
      Dict.fromList
        [ namedTypeSpec "Int8" (OpaqueTypeSpecification []) "Type that represents a 8-bit integer."
          namedTypeSpec "Int16" (OpaqueTypeSpecification []) "Type that represents a 16-bit integer."
          namedTypeSpec "Int32" (OpaqueTypeSpecification []) "Type that represents a 32-bit integer."
          namedTypeSpec "Int64" (OpaqueTypeSpecification []) "Type that represents a 64-bit integer." ]
    Values =
      Dict.fromList
