...
let encoder =
  ...
  | CharLiteral v -> Encode.list id [ Encode.string "CharLiteral"; Encode.string (String.fromChar v) ]
  ...
  | DecimalLiteral v -> Encode.list id [ Encode.string "DecimalLiteral"; Encode.string (Decimal.toString v) ]
